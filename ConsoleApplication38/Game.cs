...
namespace ConsoleApplication38
{
    class Game
    {
        ...
        string Intro()
        {
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("Welcome Dungeon Diver! Behold a strategic turn based game that explores through a vast dungeon with doors to open and roomsto explore. Be advised monsters exist within this realm and it's your job to take care of those monsters by any means");
            Console.WriteLine("necessary to level up and become stronger.Your goal is to collect items, fight, level up and");
